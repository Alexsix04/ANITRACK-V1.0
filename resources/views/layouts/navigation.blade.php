<nav x-data="navComponent()" class="fixed w-full top-0 z-50">
    <!-- Navbar -->
    <div x-ref="bar" class="bg-white border-b border-gray-100 transition-transform duration-300">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('randomizer.index')" :active="request()->routeIs('randomizer.index')">Randomizer</x-nav-link>
                    </div>
                </div>
        ...
        <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <!-- Botón de búsqueda en menu responsive -->
                <button @click="searchOpen = true"
                    class="flex items-center gap-2 p-2 w-full text-gray-700 hover:bg-gray-100 rounded">
                ...
                init() {
                    window.addEventListener('scroll', () => {
                        ...
                        if (currentScroll > this.lastScroll && currentScroll > 100) {
                            this.$refs.bar.style.transform = 'translateY(-100%)';
                        } else {
